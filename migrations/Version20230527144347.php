 ...
 */
final class Version20230527144347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__paiement AS SELECT id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, datepaiement, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres FROM paiement');
        ...
        $this->addSql('INSERT INTO paiement (id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, date_at, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres) SELECT id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, datepaiement, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres FROM __temp__paiement');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__paiement AS SELECT id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, date_at, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres FROM paiement');
        $this->addSql('DROP TABLE paiement');
        ...
        $this->addSql('INSERT INTO paiement (id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, datepaiement, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres) SELECT id, agent_id, net, cnss, ipr, avance_salaire, pret_logement, pret_frais_scolaire, pret_deuil, pret_autre, date_at, base, prime_diplome, heure_supplementaire, transport, logement, allocation_familiale, autres FROM __temp__paiement');
        $this->addSql('DROP TABLE __temp__paiement');
        $this->addSql('CREATE INDEX IDX_B1DC7A1E3414710B ON paiement (agent_id)');
    }
}
