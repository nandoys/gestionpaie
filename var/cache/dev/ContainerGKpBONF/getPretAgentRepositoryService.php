 ...
 */
class getPretAgentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PretAgentRepository' shared autowired service.
     *
     * @return \App\Repository\PretAgentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PretAgentRepository.php';

        return $container->privates['App\\Repository\\PretAgentRepository'] = new \App\Repository\PretAgentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
