 ...
 */
class getFiscaliteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FiscaliteRepository' shared autowired service.
     *
     * @return \App\Repository\FiscaliteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FiscaliteRepository.php';

        return $container->privates['App\\Repository\\FiscaliteRepository'] = new \App\Repository\FiscaliteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
