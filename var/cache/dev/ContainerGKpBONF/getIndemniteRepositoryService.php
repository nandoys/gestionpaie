 ...
 */
class getIndemniteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IndemniteRepository' shared autowired service.
     *
     * @return \App\Repository\IndemniteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndemniteRepository.php';

        return $container->privates['App\\Repository\\IndemniteRepository'] = new \App\Repository\IndemniteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
