...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AgentSalaireType' => ['privates', 'App\\Form\\AgentSalaireType', 'getAgentSalaireTypeService', true],
            'App\\Form\\AgentType' => ['privates', 'App\\Form\\AgentType', 'getAgentTypeService', true],
            'App\\Form\\FonctionType' => ['privates', 'App\\Form\\FonctionType', 'getFonctionTypeService', true],
            'App\\Form\\ImportFileType' => ['privates', 'App\\Form\\ImportFileType', 'getImportFileTypeService', true],
            'App\\Form\\IndemniteType' => ['privates', 'App\\Form\\IndemniteType', 'getIndemniteTypeService', true],
            'App\\Form\\PaiementType' => ['privates', 'App\\Form\\PaiementType', 'getPaiementTypeService', true],
            'App\\Form\\RemunerationType' => ['privates', 'App\\Form\\RemunerationType', 'getRemunerationTypeService', true],
            ...
            'App\\Form\\AgentSalaireType' => '?',
            'App\\Form\\AgentType' => '?',
            'App\\Form\\FonctionType' => '?',
            'App\\Form\\ImportFileType' => '?',
            'App\\Form\\IndemniteType' => '?',
            'App\\Form\\PaiementType' => '?',
            'App\\Form\\RemunerationType' => '?',
